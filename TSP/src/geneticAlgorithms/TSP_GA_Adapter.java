...
public class TSP_GA_Adapter {
	...
	public Object startEvolution(){
		...
		if(points!=null && resultsData!=null){
			try {
				//Create a TSP_GA object passing all the variable this class has received to setup the configuration of the Genetic Algorithm
				...
				//This will make the TSP_GA running a thread executing evolutions around the list of cities given
		...
		//Set the progress to 100% which means, operations executed and completed
		updateProgress(100);
		return null;
	}

	/*
	 * @param value	This integer value is used to set the progress of the SwingWorker object
	 * 
	 * This method updates the progress of the SwingWorker class which will then send an update to the GUI
	 */
