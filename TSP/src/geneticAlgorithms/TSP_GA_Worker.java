...
public class TSP_GA_Worker extends SwingWorker{
	 ...
	 * 
	 * @throws InvalidConfigurationException	If the configuration for the TSP_GA has some invalid parameters
	 * 
	...
	/*
	 * @param v	This is the value the tells the GUI the process is proceeding its execution correctly
	 * 
	 *  This method changes the value of the progress parameter which helps the user understanding the progress of a running thread
	 */
